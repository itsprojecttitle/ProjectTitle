...
const Hero = () => {
    ...
    return (
        <section
            id="hero"
            className="hero-section tw-relative tw-flex tw-min-h-[120vh] tw-w-full tw-max-w-[100vw] tw-flex-col tw-bg-primary tw-text-white max-lg:tw-min-h-[915px] max-lg:tw-p-4 pt-[60px]"
        >
            <div className="hero-layout tw-flex tw-h-full tw-min-h-[100vh] tw-w-full tw-justify-between tw-gap-6 tw-px-[5%] tw-pt-[5%] tw-pb-[12%] max-xl:tw-place-items-center max-lg:tw-flex-col max-lg:tw-items-start">
